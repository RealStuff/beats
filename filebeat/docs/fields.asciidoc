...
Module for parsing Sophos logs.
...
Module for parsing Sophos UTM logs.



*`sophosutm.firewall.ad_domain`*::
+
--
type: keyword
...
*`sophosutm.firewall.filteraction`*::
+
--
type: keyword
...
*`sophosutm.firewall.fullreqtime`*::
+
--
type: integer
